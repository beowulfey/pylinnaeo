...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.projectTree = QtWidgets.QTreeView(self.widget)
        ...
        self.projectTree.setBaseSize(QtCore.QSize(0, 0))
        self.projectTree.setObjectName("projectTree")
        self.gridLayout_3.addWidget(self.projectTree, 1, 1, 1, 1)
        self.alignedTree = QtWidgets.QTreeView(self.widget)
        self.alignedTree.setObjectName("alignedTree")
        self.gridLayout_3.addWidget(self.alignedTree, 2, 1, 1, 1)
