...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboTheme.setItemText(1, _translate("Form", "Monochrome"))
        self.comboTheme.setItemText(2, _translate("Form", "Color Safe"))
        self.comboTheme.setItemText(3, _translate("Form", "User Theme"))
